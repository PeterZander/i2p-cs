...
namespace I2PCore.TransportLayer.SSU
{
    ...
    {
        static readonly TickSpan RememberCompleteMessageIds = TickSpan.Seconds( 15 );
        ...
        ItemFilterWindow<uint> DupFilter = new ItemFilterWindow<uint>( RememberCompleteMessageIds, 1 );
