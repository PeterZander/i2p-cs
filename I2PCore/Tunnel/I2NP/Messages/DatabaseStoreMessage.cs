...
namespace I2PCore.Tunnel.I2NP.Messages
{
    public class DatabaseStoreMessage: I2NPMessage
    {
        ...
        public DatabaseStoreMessage( I2PRouterInfo info, uint replytoken, I2PIdentHash replygw, I2PTunnelId replytunnelid )
        {
            BufLen msb;
            ...
            if ( replytoken != 0 )
            {
                ...
                if ( replygw == null || replygw.Hash.Length != 32 ) throw new FormatException( "ReplyGateway has to be 32 bytes long!" );
        ...
        public DatabaseStoreMessage( I2PLeaseSet leaseset, uint replytoken, I2PIdentHash replygw, I2PTunnelId replytunnelid )
        {
        ...
        public DatabaseStoreMessage( I2NPHeader header, BufRef reader )
        {
